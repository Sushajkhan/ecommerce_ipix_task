    ...
    >
      ...
      <div className="flex flex-col gap-y-3  mt-4">
        <div className="flex w-full justify-between items-center">
          ...
          <div
            onClick={clearCart}
            className="cursor-pointer py-4 bg-orange-500 text-white w-12 h-12 flex justify-center items-center text-xl"
          >
            <FiTrash2 />
          </div>
        </div>
        ...
        <Link
          to={"/"}
          className="bg-orange-600 flex p-3 justify-center items-center text-white w-full font-medium hover:bg-orange-900"
        >
          Checkout
        </Link>
      </div>
